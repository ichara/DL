...
distance_scale = 1000.0  # scaled_distance = distance / distance_scale
frames = 4
...
actions = [
    ...
    (0, 'LU'),  # FOR_JUMP
    #(150, 'D', 'DL', 'LC'),  # STAND_D_DF_FC, 2 3 6 _ C
    ...
    (30, 'D', 'DL', 'LB'),  # STAND_D_DF_FB, 2 3 6 _ B (added)
    #(20, 'RB'),  # THROW_B, 4 _ B (added)
]
